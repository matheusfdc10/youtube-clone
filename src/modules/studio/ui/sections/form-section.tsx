...
const FormSectionSuspense = ({ videoId }: FormSectionProps) => {
    ...
    const isPending = remove.isPending || update.isPending || !!remove.data || restoreThumbnail.isPending || thumbnailModalOpen || thumbnailGenerateModalOpen || revalidate.isPending;
                        ...
                        <div className="flex items-center gap-x-2">
                            ...
                            <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end">
                                    <DropdownMenuItem onClick={() => revalidate.mutate({ id: videoId })} disabled={isPending}>
                                        <RotateCcwIcon className="size-4 mr-2" />
                                        Revalidate
                                    </DropdownMenuItem>
                                    <DropdownMenuItem onClick={() => remove.mutate({ id: videoId })} disabled={isPending}>
                                ...
                                <div className="p-4 flex flex-col gap-y-6">
                                    ...
                                    <div className="flex justify-between items-center">
                                        <div className="flex flex-col gap-y-1">
                                            ...
                                            <p className="text-sm">
                                                {snakeCaseToTitle(video.muxSttaus || "preparing")}
                                            </p>
                                        </div>
                                    </div>
